      ...
      >
        <SwiperSlide>
          <div className="py-4 bg-white  flex flex-col justify-center items-center  rounded">
            ...
            />
            <p className="text-md text-black capitalize py-2 font-bold ">
              Manal elan
            </p>

            <p className="py-4 text-xl leading-8 text-black italic max-w-md mb-8 ">
        ...
        <SwiperSlide>
          <div className="py-4 bg-white  flex flex-col justify-center items-center  rounded">
            ...
            <p className="py-4 text-xl leading-8 text-black italic max-w-md mb-8">
              ...
              cillum dolore eu fugiat nulla pariaturadipiscing elitreprehenderit
              in voluptate."
            </p>
          </div>
        </SwiperSlide>
